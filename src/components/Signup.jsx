...
function Signup() {
  return (
    <>
      <div className="relative w-full h-screen  text-white z-1 bg-[url(https://images.unsplash.com/photo-1514823529749-16594073828c?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)]">
        <div className="absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]">
          {/* <div className="flex justify-center my-3">
          <h1 className="logo text-6xl text-white">Green Book</h1>
        </div> */}
          <div className="bg h-[35vw] w-[25vw] py-3 bg-zinc-800/90 z-2 shadow-xl shadow-black">
